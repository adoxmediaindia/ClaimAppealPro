...
const appealReviewSchema = z.object({
  ...
  dateOfService: z.string().regex(/^(?:\d{4}-\d{2}-\d{2}|N\/A|)$/, 'Date of Service must be in YYYY-MM-DD format or N/A.'),
  denialDate: z.string().regex(/^(?:\d{4}-\d{2}-\d{2}|N\/A|)$/, 'Denial Date must be in YYYY-MM-DD format or N/A.'),
  ...
  appealDeadline: z.string().regex(/^(?:\d{4}-\d{2}-\d{2}|N\/A|)$/, 'Appeal Deadline must be in YYYY-MM-DD format or N/A.'),
