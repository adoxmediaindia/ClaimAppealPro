  ...
  return (
    <header className="flex h-16 items-center justify-between border-b border-white/[0.08] bg-[#08090B]/60 px-6 backdrop-blur-md sticky top-0 z-30">
      ...
      <div className="flex items-center space-x-4">
        ...
        {/* Notifications Icon */}
        <button className="relative rounded-md p-1.5 text-zinc-450 hover:bg-white/[0.04] hover:text-white transition-colors">
          <Bell className="h-4.5 w-4.5" />
          <span className="absolute top-1.5 right-1.5 h-1.5 w-1.5 rounded-full bg-[#4F8CFF]" />
        </button>
